...
accelerate launch \
    ...
    --weight_decay 0. \
    --num_train_epochs 3 \
    --output_dir output/$MODEL-$DATASET\_qlora \
    --with_tracking \
...
python open_instruct/merge_lora.py \
    ...
    --lora_model_name_or_path output/$MODEL-$DATASET\_qlora \
    --output_dir output/$MODEL-$DATASET\_qlora_merged/ \
    --save_tokenizer \
...
# 评估模型
bash scripts/eval/all.sh $CUDA_VISIBLE_DEVICES $MODEL-$DATASET\_qlora_merged
