...
MODEL=Meta-Llama-3-8B-alpaca_lora_merged

# use vllm for generation
python -m eval.alpaca_farm.run_eval \
    --model_name_or_path /mnt/nvme1/lyj/open-instruct/output/$MODEL \
    --tokenizer_name_or_path /mnt/nvme1/lyj/open-instruct/output/$MODEL \
    --save_dir results/alpaca_farm/$MODEL \
    --eval_batch_size 20 \
    --use_vllm \
    --use_chat_format \
